...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="broker-ws" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.upa.broker.BrokerApplication %CMD_LINE_ARGS%
